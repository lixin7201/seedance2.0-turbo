...
description: Privacy policy for seedance2.0
created_at: 2025-10-24
---

## Introduction

Welcome to Seedance 2.0, an **AI video generation platform** that provides a user-friendly interface for creating high-quality videos using advanced AI models. At Seedance 2.0, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using seedance2.0:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use seedance2.0, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access seedance2.0, such as device type, operating system, and browser type.
...
**Copyright Owner**: [seedance2.shop](https://seedance2.shop)
**Email**: [support@seedance2.shop](mailto:support@seedance2.shop)

By using seedance2.0, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
