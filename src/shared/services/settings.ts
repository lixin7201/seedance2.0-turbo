...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'evolink',
      title: 'EvoLink.AI',
      description: `Custom <a href="https://docs.evolink.ai" class="text-primary" target="_blank">EvoLink.AI</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      placeholder: 'el_xxx',
      group: 'evolink',
      tip: 'EvoLink API Key for video generation. Get it from https://evolink.ai/dashboard/keys',
      tab: 'ai',
    },
    {
      ...
      group: 'evolink',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by EvoLink',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
